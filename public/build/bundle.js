  ...
  function create_fragment$7(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        p0 = element("p");
        p0.textContent =
          "setting up my own website is very time consuming and I'm pretty much exhausted all the time.";
        t3 = space();
        p1 = element("p");
        ...
        p2 = element("p");
        t9 = text(
          "knowing me, this thing will forever be under construction - so i forced this\n\t\t\t",
        );
        a2 = element("a");
