...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-10u2fqy");
    			add_location(a, file$6, 29, 3, 887);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    // (27:3) {#if project.name === "Betty" || project.name === "chananigans"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-10u2fqy");
    			add_location(a, file$6, 27, 3, 808);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(27:3) {#if project.name === \\\"Betty\\\" || project.name === \\\"chananigans\\\"}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-10u2fqy");
    			add_location(li, file$6, 25, 2, 732);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:2) {#each projects as project}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-10u2fqy");
    			add_location(h1, file$6, 7, 3, 148);
    			add_location(header, file$6, 6, 2, 136);
    			attr_dev(p0, "class", "svelte-10u2fqy");
    			add_location(p0, file$6, 9, 2, 221);
    			attr_dev(a0, "href", "https://www.facebook.com/facebo/");
    			attr_dev(a0, "class", "svelte-10u2fqy");
    			add_location(a0, file$6, 12, 3, 375);
    			attr_dev(p1, "class", "svelte-10u2fqy");
    			add_location(p1, file$6, 11, 2, 324);
    			attr_dev(a1, "href", "https://syncretik.co");
    			attr_dev(a1, "class", "svelte-10u2fqy");
    			add_location(a1, file$6, 16, 2, 523);
    			attr_dev(p2, "class", "svelte-10u2fqy");
    			add_location(p2, file$6, 15, 2, 441);
    			attr_dev(p3, "class", "svelte-10u2fqy");
    			add_location(p3, file$6, 20, 2, 605);
    			attr_dev(div, "id", "horizontal-spacer");
    			attr_dev(div, "class", "svelte-10u2fqy");
    			add_location(div, file$6, 22, 2, 668);
    			attr_dev(section, "id", "description-section");
    			attr_dev(section, "class", "svelte-10u2fqy");
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Back";
    			attr_dev(button, "id", "back-btn");
    			add_location(button, file$2, 5, 13, 74);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 10, 2, 234);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			create_component(router.$$.fragment);
    			attr_dev(link, "href", "https://fonts.googleapis.com/css?family=Barrio");
    			attr_dev(link, "rel", "stylesheet");
    			add_location(link, file, 5, 0, 83);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
