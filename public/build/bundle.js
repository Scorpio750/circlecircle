...
var app = (function () {
    ...
    const projects = [
    		...
    		},
    		{
    			...
    			link: "http://circlecircle.studio/chananigans",
    		},
    		{
    			name: "starberry",
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-83xj2r");
    			add_location(a, file$5, 29, 4, 959);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    // (27:4) {#if project.name === "Betty" || project.name === "chananigans"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-83xj2r");
    			add_location(a, file$5, 27, 4, 878);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(27:4) {#if project.name === \\\"Betty\\\" || project.name === \\\"chananigans\\\"}",
    		ctx
    	});
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-83xj2r");
    			add_location(li, file$5, 25, 3, 800);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(25:3) {#each projects as project}",
    		ctx
    	});
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			p2 = element("p");
    			t7 = text("knowing me, this thing will forever be under construction - so i forced this\n\t\t\t");
    			a1 = element("a");
    			a1.textContent = "shit-eating goblin";
    			t9 = text("\n\t\t\tto make it for me");
    			t10 = space();
    			p3 = element("p");
    			...
    			attr_dev(h1, "class", "svelte-83xj2r");
    			add_location(h1, file$5, 7, 3, 148);
    			add_location(header, file$5, 6, 2, 136);
    			attr_dev(p0, "class", "svelte-83xj2r");
    			add_location(p0, file$5, 10, 3, 248);
    			attr_dev(a0, "href", "https://www.facebook.com/facebo/");
    			attr_dev(a0, "class", "svelte-83xj2r");
    			add_location(a0, file$5, 13, 4, 404);
    			attr_dev(p1, "class", "svelte-83xj2r");
    			add_location(p1, file$5, 12, 3, 352);
    			attr_dev(a1, "href", "https://syncretik.co");
    			attr_dev(a1, "class", "svelte-83xj2r");
    			add_location(a1, file$5, 17, 3, 555);
    			attr_dev(p2, "class", "svelte-83xj2r");
    			add_location(p2, file$5, 16, 3, 472);
    			attr_dev(p3, "class", "svelte-83xj2r");
    			add_location(p3, file$5, 20, 3, 638);
    			attr_dev(div0, "class", "text-tile svelte-83xj2r");
    			add_location(div0, file$5, 9, 2, 221);
    			attr_dev(div1, "id", "horizontal-spacer");
    			attr_dev(div1, "class", "svelte-83xj2r");
    			add_location(div1, file$5, 22, 2, 709);
    			attr_dev(div2, "class", "text-tile svelte-83xj2r");
    			add_location(div2, file$5, 23, 2, 742);
    			attr_dev(section, "id", "description-section");
    			attr_dev(section, "class", "svelte-83xj2r");
    			add_location(section, file$5, 5, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1og6syc");
    			add_location(a, file$4, 2, 11, 48);
    			attr_dev(footer, "class", "svelte-1og6syc");
    			add_location(footer, file$4, 1, 1, 28);
    			attr_dev(section, "id", "black-block");
    			attr_dev(section, "class", "svelte-1og6syc");
    ...
    function create_fragment$4(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			t2 = space();
    			div1 = element("div");
    			attr_dev(div0, "class", "circle svelte-1f0vxhi");
    			attr_dev(div0, "id", "circle1");
    			add_location(div0, file$3, 8, 1, 142);
    			attr_dev(div1, "class", "circle svelte-1f0vxhi");
    			attr_dev(div1, "id", "circle2");
    			add_location(div1, file$3, 9, 1, 179);
    			attr_dev(main, "class", "svelte-1f0vxhi");
    			add_location(main, file$3, 5, 0, 106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 94, 14, 2905);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 90, 0, 2755);
    			attr_dev(span, "id", "meme-btn");
    			attr_dev(span, "class", "svelte-145l76h");
    			add_location(span, file$2, 93, 19, 2829);
    			attr_dev(h20, "class", "svelte-145l76h");
    			add_location(h20, file$2, 93, 1, 2811);
    			attr_dev(h21, "class", "svelte-145l76h");
    			add_location(h21, file$2, 92, 14, 2805);
    			attr_dev(h22, "class", "svelte-145l76h");
    			add_location(h22, file$2, 92, 1, 2792);
    			attr_dev(main, "class", "svelte-145l76h");
    			add_location(main, file$2, 91, 0, 2784);
    			...
    			add_location(img, file$2, 97, 0, 2957);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Back";
    			attr_dev(button, "id", "back-btn");
    			add_location(button, file$1, 5, 13, 74);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    		},
