    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-4s7t9s");
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-4s7t9s");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-171ercf");
    			add_location(a, file$5, 2, 11, 48);
    			attr_dev(footer, "class", "svelte-171ercf");
    			add_location(footer, file$5, 1, 1, 28);
    			attr_dev(section, "id", "black-block");
    			attr_dev(section, "class", "svelte-171ercf");
