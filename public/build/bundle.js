...
var app = (function () {
  ...
  // (8:2) <Carousel    autoplay    autoplayDuration={5000}    arrows={false}    particlesToShow={1}    particlesToScroll={2}   >
  ...
  function create_fragment$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div1, file$1, 6, 0, 147);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(h1, file, 7, 2, 133);
        add_location(header, file, 6, 1, 122);
        attr_dev(main, "class", "svelte-faywab");
        ...
        add_location(path0, file, 16, 3, 437);
        ...
        add_location(svg0, file, 15, 4, 306);
        attr_dev(a0, "href", "https://www.instagram.com/copy____cat___/");
        attr_dev(a0, "class", "svelte-faywab");
        add_location(a0, file, 14, 2, 249);
        attr_dev(
          path1,
          "d",
        ...
        add_location(path1, file, 21, 3, 2093);
        ...
        add_location(svg1, file, 20, 3, 1963);
        attr_dev(a1, "href", "https://www.facebook.com/facebo/");
        attr_dev(a1, "class", "svelte-faywab");
        add_location(a1, file, 19, 2, 1916);
        attr_dev(div, "id", "social-links");
        add_location(div, file, 13, 1, 223);
        attr_dev(a2, "href", "https://syncretik.co");
        attr_dev(a2, "class", "svelte-faywab");
        add_location(a2, file, 25, 16, 2434);
        add_location(span, file, 25, 1, 2419);
        attr_dev(footer, "class", "svelte-faywab");
        add_location(footer, file, 12, 0, 213);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
