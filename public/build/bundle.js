    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "circle svelte-13bygkq");
    			attr_dev(div0, "id", "circle1");
    			add_location(div0, file, 9, 1, 182);
    			attr_dev(div1, "class", "circle svelte-13bygkq");
    			attr_dev(div1, "id", "circle2");
    			add_location(div1, file, 10, 1, 219);
    			attr_dev(main, "class", "svelte-13bygkq");
    			add_location(main, file, 7, 0, 162);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
