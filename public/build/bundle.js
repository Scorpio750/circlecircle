  ...
  function create_fragment$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        div1 = element("div");
        div0 = element("div");
        add_location(b0, file$1, 8, 29, 410);
        add_location(big0, file$1, 8, 24, 405);
        add_location(big1, file$1, 8, 19, 400);
        add_location(br0, file$1, 8, 60, 441);
        add_location(b1, file$1, 8, 80, 461);
        attr_dev(span0, "lang", "ja");
        add_location(span0, file$1, 8, 64, 445);
        add_location(i, file$1, 8, 102, 483);
        attr_dev(td0, "colspan", "2");
        add_location(td0, file$1, 8, 3, 384);
        set_style(tr0, "text-align", "center");
        add_location(tr0, file$1, 7, 8, 350);
        ...
        add_location(img, file$1, 11, 95, 642);
        attr_dev(a0, "href", "/wiki/File:CopycatLGPE.png");
        attr_dev(a0, "class", "image");
        add_location(a0, file$1, 11, 44, 591);
        add_location(br1, file$1, 11, 240, 787);
        attr_dev(
          a1,
          "href",
        ...
        add_location(a1, file$1, 11, 278, 825);
        add_location(small, file$1, 11, 244, 791);
        set_style(td1, "background", "#FFF");
        attr_dev(td1, "colspan", "2");
        add_location(td1, file$1, 11, 3, 550);
        set_style(tr1, "text-align", "center");
        add_location(tr1, file$1, 10, 2, 516);
        set_style(span1, "color", "#000");
        add_location(span1, file$1, 14, 115, 1154);
        attr_dev(a2, "href", "/wiki/Gender");
        attr_dev(a2, "title", "Gender");
        add_location(a2, file$1, 14, 77, 1116);
        attr_dev(th0, "class", "roundytl roundybl");
        set_style(th0, "text-align", "right");
        set_style(th0, "overflow", "hidden");
        add_location(th0, file$1, 14, 4, 1043);
        attr_dev(td2, "class", "roundytr roundybr");
        set_style(td2, "overflow", "hidden");
        add_location(td2, file$1, 16, 4, 1212);
        add_location(tr2, file$1, 13, 3, 1034);
        set_style(span2, "color", "#000");
        add_location(span2, file$1, 19, 49, 1341);
        set_style(th1, "text-align", "right");
        set_style(th1, "overflow", "hidden");
        add_location(th1, file$1, 19, 2, 1294);
        set_style(td3, "overflow", "hidden");
        add_location(td3, file$1, 21, 2, 1393);
        add_location(tr3, file$1, 18, 1, 1287);
        set_style(span3, "color", "#000");
        add_location(span3, file$1, 24, 96, 1546);
        attr_dev(a3, "href", "/wiki/Region");
        attr_dev(a3, "title", "Region");
        add_location(a3, file$1, 24, 58, 1508);
        attr_dev(th2, "class", "");
        set_style(th2, "text-align", "right");
        set_style(th2, "overflow", "hidden");
        add_location(th2, file$1, 24, 2, 1452);
        attr_dev(td4, "class", "");
        set_style(td4, "overflow", "hidden");
        add_location(td4, file$1, 26, 2, 1600);
        add_location(tr4, file$1, 23, 1, 1445);
        set_style(th3, "text-align", "right");
        set_style(th3, "overflow", "hidden");
        add_location(th3, file$1, 29, 2, 1664);
        set_style(td5, "overflow", "hidden");
        add_location(td5, file$1, 31, 1, 1730);
        add_location(tr5, file$1, 28, 1, 1657);
        set_style(th4, "text-align", "right");
        set_style(th4, "overflow", "hidden");
        add_location(th4, file$1, 34, 2, 1815);
        set_style(td6, "overflow", "hidden");
        add_location(td6, file$1, 36, 2, 1883);
        add_location(tr6, file$1, 33, 1, 1808);
        set_style(th5, "text-align", "right");
        set_style(th5, "overflow", "hidden");
        add_location(th5, file$1, 40, 2, 1946);
        set_style(td7, "overflow", "hidden");
        add_location(td7, file$1, 42, 2, 2015);
        add_location(tr7, file$1, 39, 1, 1939);
        add_location(tbody, file$1, 7, 1, 343);
