...
var app = (function () {
    ...
    const file$7 = "src/Description.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-14stb5n");
    			add_location(a, file$7, 30, 4, 971);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    // (28:4) {#if project.name === "Betty" || project.name === "catdance"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-14stb5n");
    			add_location(a, file$7, 28, 4, 890);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(28:4) {#if project.name === \\\"Betty\\\" || project.name === \\\"catdance\\\"}",
    		ctx
    	});
    ...
    function create_each_block$1(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*project*/ ctx[0].name === "Betty" || /*project*/ ctx[0].name === "catdance") return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-14stb5n");
    			add_location(li, file$7, 26, 3, 815);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-14stb5n");
    			add_location(h1, file$7, 7, 3, 148);
    			add_location(header, file$7, 6, 2, 136);
    			attr_dev(p0, "class", "svelte-14stb5n");
    			add_location(p0, file$7, 10, 3, 218);
    			attr_dev(a0, "href", "https://www.instagram.com/copy____cat___/");
    			attr_dev(a0, "class", "svelte-14stb5n");
    			add_location(a0, file$7, 13, 4, 374);
    			attr_dev(a1, "href", "https://www.facebook.com/facebo/");
    			attr_dev(a1, "class", "svelte-14stb5n");
    			add_location(a1, file$7, 15, 4, 453);
    			attr_dev(p1, "class", "svelte-14stb5n");
    			add_location(p1, file$7, 12, 3, 322);
    			attr_dev(a2, "href", "https://syncretik.co");
    			attr_dev(a2, "class", "svelte-14stb5n");
    			add_location(a2, file$7, 19, 3, 604);
    			attr_dev(p2, "class", "svelte-14stb5n");
    			add_location(p2, file$7, 18, 3, 521);
    			attr_dev(p3, "class", "svelte-14stb5n");
    			add_location(p3, file$7, 22, 3, 687);
    			attr_dev(div0, "class", "text-tile svelte-14stb5n");
    			add_location(div0, file$7, 9, 2, 191);
    			attr_dev(div1, "class", "texttile");
    			add_location(div1, file$7, 24, 2, 758);
    			attr_dev(section, "id", "description-section");
    			attr_dev(section, "class", "svelte-14stb5n");
    			add_location(section, file$7, 5, 0, 99);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(a, file$6, 2, 11, 48);
    			attr_dev(footer, "class", "svelte-1kw3red");
    			add_location(footer, file$6, 1, 1, 28);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block_1 = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-1u5yuu");
    			add_location(main, file$5, 5, 0, 106);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$4, 4, 13, 73);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$3, 92, 19, 2807);
    			attr_dev(h20, "class", "svelte-9ojjab");
    			add_location(h20, file$3, 92, 1, 2789);
    			if (!src_url_equal(img.src, img_src_value = "./assets/awake but at what cost.jpg")) attr_dev(img, "src", img_src_value);
    			attr_dev(img, "alt", "boobooboo");
    			attr_dev(img, "class", "svelte-9ojjab");
    			add_location(img, file$3, 94, 1, 2886);
    			attr_dev(h21, "class", "svelte-9ojjab");
    			add_location(h21, file$3, 91, 14, 2783);
    			attr_dev(h22, "class", "svelte-9ojjab");
    			add_location(h22, file$3, 91, 1, 2770);
    			attr_dev(main, "class", "svelte-9ojjab");
    			add_location(main, file$3, 90, 0, 2762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/CatDance.svelte generated by Svelte v3.42.1 */
    const file$2 = "src/CatDance.svelte";
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<CatDance> was created with unknown prop '${key}'`);
    	});
    ...
    class CatDance extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route({
    			props: { path: "catdance", component: CatDance },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 11, 2, 278);
    		},
    		m: function mount(target, anchor) {
