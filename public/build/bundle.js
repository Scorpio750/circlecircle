...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-gt1q11");
    			add_location(a, file$3, 44, 2, 1526);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    // (42:2) {#if project.name === "Betty" || project.name === "chananigans"}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-gt1q11");
    			add_location(a, file$3, 42, 2, 1449);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(42:2) {#if project.name === \\\"Betty\\\" || project.name === \\\"chananigans\\\"}",
    		ctx
    	});
    ...
    // (40:1) {#each projects as project}
    function create_each_block(ctx) {
    	let li;
    	let t0;
    	let t1_value = /*project*/ ctx[1].description + "";
    	let t1;
    	let t2;

    	function select_block_type(ctx, dirty) {
    		if (/*project*/ ctx[1].name === "Betty" || /*project*/ ctx[1].name === "chananigans") return create_if_block;
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-gt1q11");
    			add_location(li, file$3, 40, 1, 1375);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(40:1) {#each projects as project}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-gt1q11");
    			add_location(h1, file$3, 25, 0, 838);
    			add_location(p0, file$3, 27, 1, 908);
    			attr_dev(a0, "href", "https://www.facebook.com/facebo/");
    			attr_dev(a0, "class", "svelte-gt1q11");
    			add_location(a0, file$3, 30, 2, 1060);
    			add_location(p1, file$3, 29, 1, 1010);
    			attr_dev(a1, "href", "https://syncretik.co");
    			attr_dev(a1, "class", "svelte-gt1q11");
    			add_location(a1, file$3, 34, 1, 1205);
    			add_location(p2, file$3, 33, 1, 1124);
    			add_location(p3, file$3, 38, 1, 1285);
    			add_location(section, file$3, 26, 0, 897);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ link, projects });
    	return [projects];
    }
