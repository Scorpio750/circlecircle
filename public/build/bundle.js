    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-lxjbwl");
    			add_location(a, file$6, 29, 4, 959);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-lxjbwl");
    			add_location(a, file$6, 27, 4, 878);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, a, anchor);
    			append_dev(a, t);
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(t1_value);
    			t2 = space();
    			attr_dev(li, "class", "svelte-lxjbwl");
    			add_location(li, file$6, 25, 3, 800);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-lxjbwl");
    			add_location(h1, file$6, 7, 3, 148);
    			add_location(header, file$6, 6, 2, 136);
    			attr_dev(p0, "class", "svelte-lxjbwl");
    			add_location(p0, file$6, 10, 3, 248);
    			attr_dev(a0, "href", "https://www.facebook.com/facebo/");
    			attr_dev(a0, "class", "svelte-lxjbwl");
    			add_location(a0, file$6, 13, 4, 404);
    			attr_dev(p1, "class", "svelte-lxjbwl");
    			add_location(p1, file$6, 12, 3, 352);
    			attr_dev(a1, "href", "https://syncretik.co");
    			attr_dev(a1, "class", "svelte-lxjbwl");
    			add_location(a1, file$6, 17, 3, 555);
    			attr_dev(p2, "class", "svelte-lxjbwl");
    			add_location(p2, file$6, 16, 3, 472);
    			attr_dev(p3, "class", "svelte-lxjbwl");
    			add_location(p3, file$6, 20, 3, 638);
    			attr_dev(div0, "class", "text-tile svelte-lxjbwl");
    			add_location(div0, file$6, 9, 2, 221);
    			attr_dev(div1, "id", "horizontal-spacer");
    			attr_dev(div1, "class", "svelte-lxjbwl");
    			add_location(div1, file$6, 22, 2, 709);
    			attr_dev(div2, "class", "text-tile svelte-lxjbwl");
    			add_location(div2, file$6, 23, 2, 742);
    			attr_dev(section, "id", "description-section");
    			attr_dev(section, "class", "svelte-lxjbwl");
