...
var app = (function () {
  ...
  const file$8 = "node_modules/svelte-carousel/src/components/Dot/Dot.svelte";
  ...
  function create_fragment$8(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(button, file$8, 7, 0, 99);
      },
  ...
  const file$7 = "node_modules/svelte-carousel/src/components/Dots/Dots.svelte";
  ...
  function create_each_block(key_1, ctx) {
    ...
    const block = {
      ...
      c: function create() {
        ...
        add_location(div, file$7, 23, 4, 515);
        this.first = div;
      },
      m: function mount(target, anchor) {
  ...
  function create_fragment$7(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div, file$7, 21, 0, 411);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
  ...
  function create_fragment$6(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(i, file$6, 19, 2, 393);
        attr_dev(
          button,
          "class",
        ...
        add_location(button, file$6, 14, 0, 256);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
  ...
  function create_fragment$5(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(div, file$5, 11, 0, 192);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
  ...
  function create_if_block_2(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(img, file$3, 5, 1, 181);
      },
      m: function mount(target, anchor) {
  ...
  function create_if_block_1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(img, file$3, 3, 1, 62);
      },
      m: function mount(target, anchor) {
        insert_dev(target, img, anchor);
      },
  ...
  function create_if_block(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        add_location(img, file$3, 1, 1, 14);
      },
      m: function mount(target, anchor) {
        insert_dev(target, img, anchor);
      },
  ...
  const file$2 = "src/Portfolio.svelte";
  ...
  function create_fragment$1(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        br1 = element("br");
        small = element("small");
        t5 = text("Screenshot of Copycat from ");
        a1 = element("a");
        a1.textContent = "Pokémon: Let's Bo, Pikachu! and Let's Bo, Eevee!";
        t7 = space();
        tr2 = element("tr");
        th0 = element("th");
        a2 = element("a");
        ...
        tr5 = element("tr");
        th3 = element("th");
        th3.textContent = "Relatives";
        t21 = space();
        td5 = element("td");
        td5.textContent = "Unnamed father, unnamed grandmother";
        t23 = space();
        tr6 = element("tr");
        th4 = element("th");
        th4.textContent = "Generation";
        t25 = space();
        td6 = element("td");
        td6.textContent = "Millenial";
        t27 = space();
        tr7 = element("tr");
        th5 = element("th");
        ...
        div1 = element("div");
        div0 = element("div");
        add_location(b0, file$1, 8, 29, 377);
        add_location(big0, file$1, 8, 24, 372);
        add_location(big1, file$1, 8, 19, 367);
        add_location(br0, file$1, 8, 60, 408);
        add_location(b1, file$1, 8, 80, 428);
        attr_dev(span0, "lang", "ja");
        add_location(span0, file$1, 8, 64, 412);
        add_location(i, file$1, 8, 102, 450);
        attr_dev(td0, "colspan", "2");
        add_location(td0, file$1, 8, 3, 351);
        set_style(tr0, "text-align", "center");
        add_location(tr0, file$1, 7, 8, 317);
        ...
        add_location(img, file$1, 11, 110, 624);
        attr_dev(a0, "href", "/wiki/File:CopycatLGPE.png");
        attr_dev(a0, "class", "image");
        add_location(a0, file$1, 11, 59, 573);
        add_location(br1, file$1, 11, 255, 769);
        attr_dev(
          a1,
          "href",
          "/wiki/Pok%C3%A9mon:_Let%27s_Bo,_Pikachu!_and_Let%27s_Bo,_Eevee!",
        );
        attr_dev(
          a1,
          "title",
          "Pokémon: Let's Bo, Pikachu! and Let's Bo, Eevee!",
        );
        add_location(a1, file$1, 11, 293, 807);
        add_location(small, file$1, 11, 259, 773);
        attr_dev(td1, "class", "roundy");
        set_style(td1, "background", "#FFF");
        attr_dev(td1, "colspan", "2");
        add_location(td1, file$1, 11, 3, 517);
        set_style(tr1, "text-align", "center");
        add_location(tr1, file$1, 10, 2, 483);
        set_style(span1, "color", "#000");
        add_location(span1, file$1, 14, 118, 1139);
        attr_dev(a2, "href", "/wiki/Gender");
        attr_dev(a2, "title", "Gender");
        add_location(a2, file$1, 14, 80, 1101);
        attr_dev(th0, "class", "roundytl roundybl");
        set_style(th0, "text-align", "right");
        set_style(th0, "background", "#C6C6A7");
        add_location(th0, file$1, 14, 4, 1025);
        attr_dev(td2, "class", "roundytr roundybr");
        set_style(td2, "background", "#FFF");
        add_location(td2, file$1, 16, 4, 1197);
        add_location(tr2, file$1, 13, 3, 1016);
        set_style(span2, "color", "#000");
        add_location(span2, file$1, 19, 69, 1348);
        attr_dev(th1, "class", "roundytl");
        set_style(th1, "text-align", "right");
        set_style(th1, "background", "#C6C6A7");
        add_location(th1, file$1, 19, 2, 1281);
        attr_dev(td3, "class", "roundytr");
        set_style(td3, "background", "#FFF");
        add_location(td3, file$1, 21, 2, 1400);
        add_location(tr3, file$1, 18, 1, 1274);
        set_style(span3, "color", "#000");
        add_location(span3, file$1, 24, 99, 1572);
        attr_dev(a3, "href", "/wiki/Region");
        attr_dev(a3, "title", "Region");
        add_location(a3, file$1, 24, 61, 1534);
        attr_dev(th2, "class", "");
        set_style(th2, "text-align", "right");
        set_style(th2, "background", "#C6C6A7");
        add_location(th2, file$1, 24, 2, 1475);
        attr_dev(td4, "class", "");
        set_style(td4, "background", "#FFF");
        add_location(td4, file$1, 26, 2, 1626);
        add_location(tr4, file$1, 23, 1, 1468);
        attr_dev(th3, "class", "roundybl");
        set_style(th3, "text-align", "right");
        set_style(th3, "background", "#C6C6A7");
        add_location(th3, file$1, 29, 2, 1689);
        attr_dev(td5, "class", "roundybr");
        set_style(td5, "background", "#FFF");
        add_location(td5, file$1, 31, 1, 1775);
        add_location(tr5, file$1, 28, 1, 1682);
        attr_dev(th4, "class", "roundytl");
        set_style(th4, "text-align", "right");
        set_style(th4, "background", "#C6C6A7");
        add_location(th4, file$1, 34, 2, 1876);
        attr_dev(td6, "class", "roundytr");
        set_style(td6, "background", "#FFF");
        add_location(td6, file$1, 36, 2, 1964);
        add_location(tr6, file$1, 33, 1, 1869);
        attr_dev(th5, "class", "roundybl");
        set_style(th5, "text-align", "right");
        set_style(th5, "background", "#C6C6A7");
        add_location(th5, file$1, 40, 2, 2043);
        attr_dev(td7, "class", "roundybr");
        set_style(td7, "background", "#FFF");
        add_location(td7, file$1, 42, 2, 2132);
        add_location(tr7, file$1, 39, 1, 2036);
        add_location(tbody, file$1, 7, 1, 310);
        attr_dev(table, "class", "roundy");
        set_style(table, "float", "right");
        set_style(table, "background", "#A8A878");
        set_style(table, "margin-left", "10px");
        set_style(table, "margin-bottom", "10px");
        set_style(table, "border", "3px solid #6D6D4E");
        set_style(table, "max-width", "430px", 1);
        add_location(table, file$1, 6, 0, 147);
        attr_dev(div0, "class", "text-tile");
        add_location(div0, file$1, 47, 1, 2543);
        attr_dev(div1, "id", "description-section");
        attr_dev(div1, "class", "svelte-g1vdq4");
        add_location(div1, file$1, 46, 0, 2511);
      },
      l: function claim(nodes) {
        throw new Error(
          "options.hydrate only works if the component was compiled with the `hydratable: true` option",
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$capture_state = () => ({ Portfolio, Description });
    return [];
  }
